...
public class DeathCounterAndRandomNames : MonoBehaviour
{
    ...
    string[] middleNamesAndAcronymsArray;
    string[] finalNames;
    [SerializeField]
    ...
    void GenerateNames()
    {
        ...
        {
            int randomFirstNameIndex = Random.Range(0, firstNamesArray.Length);
            int randomLastNameIndex = Random.Range(0, lastNamesArray.Length);
            int randomMiddleNameIndex = -1;
            int oddsOfHavingMiddleName = Random.Range(0, 3);
            if(oddsOfHavingMiddleName == 1)
            {
                randomMiddleNameIndex = Random.Range(0, middleNamesAndAcronymsArray.Length);
            }

            string name = "";
            if(randomMiddleNameIndex == -1)
            {
                name = firstNamesArray[randomFirstNameIndex] + " " + lastNamesArray[randomLastNameIndex];
            }
            else
            {
                name = firstNamesArray[randomFirstNameIndex] + " " + middleNamesAndAcronymsArray[randomMiddleNameIndex] + " " + lastNamesArray[randomLastNameIndex];
            }
    ...
    void Update()
    {
        if (!hasGeneratedNames && totalEnemies != 0)
        {
            hasGeneratedNames = true;
            finalNames = new string[totalEnemies];
            GenerateNames();
        }
        ...
        if(diff <= 105 && !hasDisplayedNames && hasFinishedGeneratingNames)
        {
            for (int i = 0; i < rosterUIObjects.Length; i++)
            {
