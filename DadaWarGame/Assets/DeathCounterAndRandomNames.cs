...
public class DeathCounterAndRandomNames : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            ProgressBar.maximum = totalEnemies;
    ...
    private string middleNames = "DAVIS,MARTINEZ,WILSON,THOMAS,CHRISTOPHER,DANIEL,PAUL,MARK,JEANNIE,MIRANDA,DIXIE,LUCIA,MARTA,FAITH,LELA,K.,M.,R.R.,L.,T,H.,A.,U.,P.,B.,C.,D.,E.,E.E.,F.,H.,J.,L.K.,";
}
